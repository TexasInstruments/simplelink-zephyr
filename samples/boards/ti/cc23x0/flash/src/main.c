...
#define TEST_ZONE_OFFSET  0x19000

#define FLASH_TEST_OFFSET2 0x24000

#define FLASH_TEST_PAGE_IDX 37

#define TEST_PARTITION_OFFSET TEST_ZONE_OFFSET
...
int main(void)
{
	...
	printf("\nTI CC23x0 Flash Testing\n");
	printf("=========================\n");

	printf("\nTest 1: Flash erase page at 0x%x\n", TEST_ZONE_OFFSET);
	if (flash_erase(flash_dev, TEST_ZONE_OFFSET, FLASH_PAGE_SIZE) != 0) {
