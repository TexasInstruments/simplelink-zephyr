...
#define HCI_EXT_SetFreqTuneCmd(...)                                (icall_directAPI((uint32_t) IDX_HCI_EXT_SetFreqTuneCmd , ##__VA_ARGS__))
#define HCI_EXT_SaveFreqTuneCmd(...)                               (icall_directAPI((uint32_t) IDX_HCI_EXT_SaveFreqTuneCmd))
...
/* HCI CS API */
/**************/
#define HCI_CS_ReadLocalSupportedCapabilities(...)    (icall_directAPI((uint32_t) IDX_HCI_CS_ReadLocalSupportedCapabilities , ##__VA_ARGS__))
#define HCI_CS_ReadRemoteSupportedCapabilities(...)   (icall_directAPI((uint32_t) IDX_HCI_CS_ReadRemoteSupportedCapabilities , ##__VA_ARGS__))
