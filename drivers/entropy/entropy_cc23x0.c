...
#if (CONFIG_ENTROPY_CC23X0_NOISE_INPUT_WORD_LENGTH < 256) || \
	(CONFIG_ENTROPY_CC23X0_NOISE_INPUT_WORD_LENGTH > 1024)
#error "ENTROPY_CC23X0_NOISE_INPUT_WORD_LENGTH must be at least 256 words and at most 1024 words"
#endif
