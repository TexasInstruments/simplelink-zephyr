...
#if (CONFIG_ENTROPY_CC27XX_NOISE_INPUT_WORD_LENGTH < 256) || \
	(CONFIG_ENTROPY_CC27XX_NOISE_INPUT_WORD_LENGTH > 1024)
#error "ENTROPY_CC27XX_NOISE_INPUT_WORD_LENGTH must be at least 256 words and at most 1024 words"
#endif
...
static int entropy_cc27xx_init(const struct device *dev)
{
	...
	uint32_t rcl_noise[CONFIG_ENTROPY_CC27XX_NOISE_INPUT_WORD_LENGTH] = {0};
