...
| D3                    |  TC IRQ       |                            |
+-----------------------+---------------+----------------------------+
| D5                    | SPI CS SD     | (SD Card Chip Select)      |
+-----------------------+---------------+----------------------------+
| D6                    | SPI CS TC     | (Touch Screen Chip Select) |
+-----------------------+---------------+----------------------------+
| D8                    | ST7789V Reset |                            |
+-----------------------+---------------+----------------------------+
...
+=======================+===============+============================+
| P3                    | SPI CS SD     | (SD Card Chip Select)      |
+-----------------------+---------------+----------------------------+
| P4                    | ST7789V Reset |                            |
+-----------------------+---------------+----------------------------+
...
+-----------------------+---------------+----------------------------+
| P30                   | ST7789V DC    | (Data/Command)             |
+-----------------------+---------------+----------------------------+
| P37                   | SPI CS TC     | (Touch Screen Chip Select) |
+-----------------------+---------------+----------------------------+
| P38                   | TC IRQ        | (Touch Screen Interrupt)   |
+-----------------------+---------------+----------------------------+
...
| 1.3inch IPS LCD          |                              |
+--------------------------+------------------------------+
| Waveshare 240x320        | st7789v_waveshare_240x320    |
| 2.8inch TFT TOUCH SCREEN |                              |
+--------------------------+------------------------------+
