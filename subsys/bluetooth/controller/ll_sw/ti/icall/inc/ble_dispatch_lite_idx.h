...
/**************************************/
#define IDX_HCI_EXT_SetTxPowerCmd                        JT_INDEX(97)
#define IDX_HCI_EXT_SetTxPowerDbmCmd                     JT_INDEX(98)
#define IDX_HCI_EXT_BuildRevisionCmd                     JT_INDEX(99)
#define IDX_HCI_EXT_DelaySleepCmd                        JT_INDEX(100)
#define IDX_HCI_EXT_DecryptCmd                           JT_INDEX(101)
#define IDX_HCI_EXT_EnablePTMCmd                         JT_INDEX(102)
#define IDX_HCI_EXT_ModemTestTxCmd                       JT_INDEX(103)
#define IDX_HCI_EXT_ModemHopTestTxCmd                    JT_INDEX(104)
#define IDX_HCI_EXT_ModemTestRxCmd                       JT_INDEX(105)
#define IDX_HCI_EXT_EnhancedModemTestTxCmd               JT_INDEX(106)
#define IDX_HCI_EXT_EnhancedModemHopTestTxCmd            JT_INDEX(107)
#define IDX_HCI_EXT_EnhancedModemTestRxCmd               JT_INDEX(108)
#define IDX_HCI_EXT_EndModemTestCmd                      JT_INDEX(109)
#define IDX_HCI_EXT_SetBDADDRCmd                         JT_INDEX(110)
#define IDX_HCI_EXT_ResetSystemCmd                       JT_INDEX(111)
#define IDX_HCI_EXT_SetLocalSupportedFeaturesCmd         JT_INDEX(112)
#define IDX_HCI_EXT_SetMaxDtmTxPowerCmd                  JT_INDEX(113)
#define IDX_HCI_EXT_SetMaxDtmTxPowerDbmCmd               JT_INDEX(114)
#define IDX_HCI_EXT_SetRxGainCmd                         JT_INDEX(115)
#define IDX_HCI_EXT_ExtendRfRangeCmd                     JT_INDEX(116)
#define IDX_HCI_EXT_HaltDuringRfCmd                      JT_INDEX(117)
#define IDX_HCI_EXT_ClkDivOnHaltCmd                      JT_INDEX(118)
#define IDX_HCI_EXT_DeclareNvUsageCmd                    JT_INDEX(119)
#define IDX_HCI_EXT_MapPmIoPortCmd                       JT_INDEX(120)
#define IDX_HCI_EXT_SetFreqTuneCmd                       JT_INDEX(121)
#define IDX_HCI_EXT_SaveFreqTuneCmd                      JT_INDEX(122)
#define IDX_HCI_EXT_SetAdvSetRandAddrCmd                 JT_INDEX(123)

// <<INSERT:#if defined(CTRL_CONFIG) && (CTRL_CONFIG & (ADV_CONN_CFG | INIT_CFG))>>
// <<BEGIN_COUNT>>
#define IDX_HCI_EXT_DisconnectImmedCmd                   JT_INDEX(124)
#define IDX_HCI_EXT_PacketErrorRateCmd                   JT_INDEX(125)
#define IDX_HCI_EXT_NumComplPktsLimitCmd                 JT_INDEX(126)
#define IDX_HCI_EXT_OnePktPerEvtCmd                      JT_INDEX(127)
#define IDX_HCI_EXT_SetSCACmd                            JT_INDEX(128)
#define IDX_HCI_EXT_GetConnInfoCmd                       JT_INDEX(129)
#define IDX_HCI_EXT_OverlappedProcessingCmd              JT_INDEX(130)
// <<END_COUNT>>
// <<INSERT:#else // !(defined(CTRL_CONFIG) && (CTRL_CONFIG & (ADV_CONN_CFG | INIT_CFG)))>>
// <<INSERT_LOOP:(uint32)icall_liteErrorFunction,>>
// <<INSERT:#endif //  (defined(CTRL_CONFIG) && (CTRL_CONFIG & (ADV_CONN_CFG | INIT_CFG)))>>
...
// <<INSERT:#if defined(CTRL_CONFIG) && (CTRL_CONFIG & ADV_CONN_CFG)>>
// <<BEGIN_COUNT>>
#define IDX_HCI_EXT_SetFastTxResponseTimeCmd             JT_INDEX(131)
#define IDX_HCI_EXT_SetPeripheralLatencyOverrideCmd      JT_INDEX(132)
// <<END_COUNT>>
// <<INSERT:#else // !INIT_CFG>>
// <<INSERT_LOOP:(uint32)icall_liteErrorFunction,>>
...
// <<INSERT:#if defined(CTRL_CONFIG) && (CTRL_CONFIG & (ADV_CONN_CFG | INIT_CFG))>>
// <<BEGIN_COUNT>>
#define IDX_HCI_EXT_SetMaxDataLenCmd                     JT_INDEX(133)
// <<END_COUNT>>
// <<INSERT:#else // !(...)>>
// <<INSERT_LOOP:(uint32)icall_liteErrorFunction,>>
// <<INSERT:#endif // (...)>>
...
// <<BEGIN_COUNT>>
#define IDX_HCI_EXT_SetVirtualAdvAddrCmd                 JT_INDEX(134)
// <<END_COUNT>>
// <<INSERT:#else // !(...)>>
// <<INSERT_LOOP:(uint32)icall_liteErrorFunction,>>
// <<INSERT:#endif // (...)>>
...
// <<INSERT:#if defined(CTRL_CONFIG) && (CTRL_CONFIG & SCAN_CFG)>>
// <<BEGIN_COUNT>>
#define IDX_HCI_EXT_SetExtScanChannels				     JT_INDEX(135)
// <<END_COUNT>>
// <<INSERT:#else // !(...)>>
// <<INSERT_LOOP:(uint32)icall_liteErrorFunction,>>
// <<INSERT:#endif // (...)>>

#define IDX_HCI_EXT_SetQOSParameters	                 JT_INDEX(136)
#define IDX_HCI_EXT_SetQOSDefaultParameters	             JT_INDEX(137)

// <<INSERT:#ifdef LL_TEST_MODE>>
// <<BEGIN_COUNT>>
#define IDX_HCI_EXT_LLTestModeCmd                        JT_INDEX(138)
// <<END_COUNT>>
// <<INSERT:#else // !(...)>>
// <<INSERT_LOOP:(uint32)icall_liteErrorFunction,>>
// <<INSERT:#endif // (...)>>

#define IDX_HCI_EXT_SetDtmTxPktCntCmd                    JT_INDEX(139)

#define IDX_HCI_EXT_SetHostDefChanClassificationCmd      JT_INDEX(140)
#define IDX_HCI_EXT_SetHostConnChanClassificationCmd     JT_INDEX(141)

#define IDX_HCI_EXT_GetRxStatisticsCmd                   JT_INDEX(142)
#define IDX_HCI_EXT_GetTxStatisticsCmd                   JT_INDEX(143)
#define IDX_HCI_EXT_GetCoexStatisticsCmd                 JT_INDEX(144)

// <<INSERT:#if defined(CTRL_CONFIG) && (CTRL_CONFIG & (ADV_CONN_CFG | INIT_CFG))>>
#define IDX_HCI_SendDataPkt                              JT_INDEX(145)
// <<INSERT:#endif // ADV_CONN_CFG | INIT_CFG>>


// <<INSERT:#if defined(HCI_TL_FULL)>>
// <<BEGIN_COUNT>>
#define IDX_HCI_CommandStatusEvent                       JT_INDEX(146)
#define IDX_HCI_CommandCompleteEvent                     JT_INDEX(147)
#define IDX_HCI_bm_alloc                                 JT_INDEX(148)
#define IDX_HCI_bm_free                                  JT_INDEX(149)
// <<END_COUNT>>
...
// <<INSERT:#if defined(HCI_TL_FULL)>>
// <<BEGIN_COUNT>>
#define IDX_HCI_TL_getCmdResponderID                     JT_INDEX(150)
// <<END_COUNT>>
// <<INSERT:#else // !defined(HCI_TL_FULL)>>
// <<INSERT_LOOP:(uint32)icall_liteErrorFunction,>>
// <<INSERT:#endif // defined(HCI_TL_FULL)>>
...
// <<BEGIN_COUNT>>
#define IDX_GGS_SetParameter                             JT_INDEX(151)
#define IDX_GGS_AddService                               JT_INDEX(152)
#define IDX_GGS_GetParameter                             JT_INDEX(153)
// <<END_COUNT>>
...
// <<BEGIN_COUNT>>
#define IDX_GGS_RegisterAppCBs                           JT_INDEX(154)
// <<END_COUNT>>
...
// <<BEGIN_COUNT>>
#define IDX_GGS_SetParamValue                            JT_INDEX(155)
#define IDX_GGS_GetParamValue                            JT_INDEX(156)
// <<END_COUNT>>
...
// <<BEGIN_COUNT>>
#define IDX_GAPBondMgr_SetParameter                      JT_INDEX(157)
#define IDX_GAPBondMgr_GetParameter                      JT_INDEX(158)
#define IDX_GAPBondMgr_Pair                              JT_INDEX(159)
#define IDX_GAPBondMgr_Register                          JT_INDEX(160)
#define IDX_GAPBondMgr_PasscodeRsp                       JT_INDEX(161)
#define IDX_GAPBondMgr_FindAddr                          JT_INDEX(162)
#define IDX_GAPBondMgr_SCGetLocalOOBParameters           JT_INDEX(163)
#define IDX_GAPBondMgr_SCSetRemoteOOBParameters          JT_INDEX(164)
#define IDX_GAPBondMgr_GenerateEccKeys                   JT_INDEX(165)
#define IDX_GapBondMgr_GetPrevAuth                       JT_INDEX(166)
#define IDX_GapBondMgr_StartEnc                          JT_INDEX(167)
// <<END_COUNT>>
...
// <<BEGIN_COUNT>>
#define IDX_GAPBondMgr_ServiceChangeInd                  JT_INDEX(168)
// <<END_COUNT>>
...
// <<INSERT:#if defined(HOST_CONFIG)>>
// <<BEGIN_COUNT>>
#define IDX_GAP_DeviceInit                               JT_INDEX(169)
#define IDX_GAP_RegisterForMsgs                          JT_INDEX(170)
#define IDX_GAP_SetParamValue                            JT_INDEX(171)
#define IDX_GAP_GetParamValue                            JT_INDEX(172)
#define IDX_GapConfig_SetParameter                       JT_INDEX(173)
#define IDX_GAP_GetIRK                                   JT_INDEX(174)
#define IDX_GAP_GetSRK                                   JT_INDEX(175)
// <<END_COUNT>>
// <<INSERT:#else // !defined(HOST_CONFIG)>>
// <<INSERT_LOOP:(uint32)icall_liteErrorFunction,>>
// <<INSERT:#endif // defined(HOST_CONFIG)>>
...
// <<BEGIN_COUNT>>
#define IDX_GAP_UpdateLinkParamReq                       JT_INDEX(176)
#define IDX_GAP_TerminateLinkReq                         JT_INDEX(177)
#define IDX_GAP_UpdateLinkParamReqReply                  JT_INDEX(178)
#define IDX_GAP_Gap_RegisterConnEventCb                  JT_INDEX(179)
// <<END_COUNT>>
...
// <<BEGIN_COUNT>>
#define IDX_GapAdv_create                                JT_INDEX(180)
#define IDX_GapAdv_destroy                               JT_INDEX(181)
#define IDX_GapAdv_enable                                JT_INDEX(182)
#define IDX_GapAdv_disable                               JT_INDEX(183)
#define IDX_GapAdv_setParam                              JT_INDEX(184)
#define IDX_GapAdv_getParam                              JT_INDEX(185)
#define IDX_GapAdv_getBuffer                             JT_INDEX(186)
#define IDX_GapAdv_loadByHandle                          JT_INDEX(187)
#define IDX_GapAdv_loadByBuffer                          JT_INDEX(188)
#define IDX_GapAdv_prepareLoadByHandle                   JT_INDEX(189)
#define IDX_GapAdv_prepareLoadByBuffer                   JT_INDEX(190)
#define IDX_GapAdv_setEventMask                          JT_INDEX(191)
#define IDX_GapAdv_abortLoad                             JT_INDEX(192)
#define IDX_GapAdv_setVirtualAdvAddr                     JT_INDEX(193)
#define IDX_GapAdv_SetPeriodicAdvParams                  JT_INDEX(194)
#define IDX_GapAdv_SetPeriodicAdvData                    JT_INDEX(195)
#define IDX_GapAdv_SetPeriodicAdvEnable                  JT_INDEX(196)
// <<END_COUNT>>
...
// <<BEGIN_COUNT>>
#define IDX_GapScan_registerCb                           JT_INDEX(197)
#define IDX_GapScan_setPhyParams                         JT_INDEX(198)
#define IDX_GapScan_getPhyParams                         JT_INDEX(199)
#define IDX_GapScan_setParam                             JT_INDEX(200)
#define IDX_GapScan_getParam                             JT_INDEX(201)
#define IDX_GapScan_setEventMask                         JT_INDEX(202)
#define IDX_GapScan_enable                               JT_INDEX(203)
#define IDX_GapScan_disable                              JT_INDEX(204)
#define IDX_GapScan_getAdvReport                         JT_INDEX(205)
#define IDX_GapScan_discardAdvReportList                 JT_INDEX(206)
#define IDX_GapScan_PeriodicAdvCreateSync                JT_INDEX(207)
#define IDX_GapScan_PeriodicAdvCreateSyncCancel          JT_INDEX(208)
#define IDX_GapScan_PeriodicAdvTerminateSync             JT_INDEX(209)
#define IDX_GapScan_SetPeriodicAdvReceiveEnable          JT_INDEX(210)
#define IDX_GapScan_AddDeviceToPeriodicAdvList           JT_INDEX(211)
#define IDX_GapScan_RemoveDeviceFromPeriodicAdvList      JT_INDEX(212)
#define IDX_GapScan_ReadPeriodicAdvListSize              JT_INDEX(213)
#define IDX_GapScan_ClearPeriodicAdvList                 JT_INDEX(214)
// <<END_COUNT>>
...
// <<BEGIN_COUNT>>
#define IDX_GapInit_setPhyParam                          JT_INDEX(215)
#define IDX_GapInit_getPhyParam                          JT_INDEX(216)
#define IDX_GapInit_connect                              JT_INDEX(217)
#define IDX_GapInit_connectAl                            JT_INDEX(218)
#define IDX_GapInit_cancelConnect                        JT_INDEX(219)
// <<END_COUNT>>
...
// <<INSERT:#if defined(HOST_CONFIG)>>
// <<BEGIN_COUNT>>
#define IDX_GAP_TerminateAuth                            JT_INDEX(220)
#define IDX_GAP_Authenticate                             JT_INDEX(221)
