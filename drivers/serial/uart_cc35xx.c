...
/*
 * uart_cc35xx_fifo_fill - Write up to 'size' bytes into the TX FIFO.
 *
 * Stops early if the FIFO becomes full.
...
/*
 * uart_cc35xx_fifo_read - Read up to 'size' bytes from the RX FIFO.
 *
 * Stops early if the FIFO becomes empty.
