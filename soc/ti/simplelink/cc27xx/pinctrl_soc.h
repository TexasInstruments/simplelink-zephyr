...
#ifndef TI_SIMPLELINK_CC27XX_SOC_PINCTRL_H_
#define TI_SIMPLELINK_CC27XX_SOC_PINCTRL_H_
...
#define CC27XX_PIN_FLAGS(node_id) \
...
#define CC27XX_DT_PIN(node_id)					\
	{							\
		.pin = DT_PROP_BY_IDX(node_id, pinmux, 0),	\
		.iofunc = DT_PROP_BY_IDX(node_id, pinmux, 1),	\
		.iomode = CC27XX_PIN_FLAGS(node_id)		\
	},

#define Z_PINCTRL_STATE_PIN_INIT(node_id, prop, idx)		\
	CC27XX_DT_PIN(DT_PROP_BY_IDX(node_id, prop, idx))

#define Z_PINCTRL_STATE_PINS_INIT(node_id, prop)		\
	{ DT_FOREACH_PROP_ELEM(node_id, prop, Z_PINCTRL_STATE_PIN_INIT) }

#endif /* TI_SIMPLELINK_CC27XX_SOC_PINCTRL_H_ */
